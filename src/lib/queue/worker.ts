...
Schema for each topic candidate in the array:
{
  ...
  "whyHostAWillAgree": "Why ${topicHostA.name} (the higher-intensity host) will take a strong stance",
  "whyHostBWillDisagree": "Why ${topicHostB.name} (the lower-intensity host) will contradict them from their own worldview",
