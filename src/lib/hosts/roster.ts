...
export const SEED_HOSTS: SeedHost[] = [
  {
    ...
    speakingStyle:
      "Fast, flat Northwest Indiana vowels, smoker's edge. Contractions always, endings bitten off, sentences left as fragments when she is moving. Builds in stacks — three short clauses, then a long one that lands. Starts laughing while she is still attacking. Uses a person's full name when she is furious. Talks over people to interrupt. Once per fight she drops to quiet and slow, and that is her most dangerous register. Anger makes her louder and faster.",
    catchphrases: [],
