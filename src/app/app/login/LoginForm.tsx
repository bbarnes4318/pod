...
import { loginAction, googleLoginAction, type AuthActionState } from "@/lib/authActions";
  ...
  return (
    <>
      ...
      <div className="uAuthAlt">
        New to Take Machine?{" "}
        <Link href={`/app/signup${callbackUrl !== "/app" ? `?callbackUrl=${encodeURIComponent(callbackUrl)}` : ""}`}>
          Create an account
        </Link>
      </div>
    </>
