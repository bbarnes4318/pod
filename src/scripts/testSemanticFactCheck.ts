...
const LINES = [
  { lineIndex: 0, speakerName: "Zabala", text: "Welcome in — I'm Bernie Zabala, that's Cal Mercer.", isFactualClaim: false },
  { lineIndex: 1, speakerName: "Zabala", text: "It's a good start!", isFactualClaim: false },
  { lineIndex: 2, speakerName: "Mercer", text: "[interrupting] So the man who said one game means nothin'—", isFactualClaim: false },
  { lineIndex: 3, speakerName: "Mercer", text: "Skubal threw a perfect game with 27 strikeouts last night.", isFactualClaim: true }, // false claim
];
  ...
  (async () => {
    const flagged = await reviewFactualLinesForRewrite(stubProvider, {
      reviewLines: [
        ...
        { lineIndex: 1, speakerName: "Mercer", text: "Five homers.", isFactualClaim: true },
        { lineIndex: 2, speakerName: "Zabala", text: "Oh, come on.", isFactualClaim: false },
        { lineIndex: 3, speakerName: "Mercer", text: "They're 48-38.", isFactualClaim: true },
      ],
